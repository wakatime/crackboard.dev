import {
  getLeadersForLanguageQuery,
  getLeadersForProviderQuery,
  updateLastViewedTimestamp,
  userToPublicUser,
} from '@acme/core/backend/helpers';
import { badgeInfoForProviderScore } from '@acme/core/integrations/extensions/getters';
import { integrations } from '@acme/core/integrations/integration-list';
import { leadersFilterOptions } from '@acme/core/validators';
import { and, db, desc, eq, gt, isNotNull, sql } from '@acme/db/drizzle';
import { Integration, IntegrationIdentifier, ProgramLanguage, ProgramLanguageBadge, User } from '@acme/db/schema';
import { z } from 'zod';
