...
const DrawerContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content> & { showDragBar?: boolean }
>(({ className, children, showDragBar = true, ...props }, ref) => (
  <DrawerPortal>
    <DrawerOverlay />
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      {showDragBar && <div className="bg-muted mx-auto mt-4 h-2 w-[100px] rounded-full" />}
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
